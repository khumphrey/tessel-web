...
$(document).ready(function()
{
	...
	$('#stirve').click(function(){
		$('#stirve').hide();
		$('#replaceMeWithCoffee').html('<img src = "./img/giphy.gif">');
		$('#replaceMeWithMsg').html('<h3 class="text-center mg-lg animated fadeIn">We will message you when your coffee is ready!</h3>');

		//ajax request
		$.get('http://192.168.2.201:1337');
	})
});
